...
function SearchBar() {
  ...
  return (
    <div className="w-100 flex justify-center py-16">
      <input ref={wrapperRef} type="text" onClick={() => setIsFocused(!isFocused)} placeholder="Search for anime..." className={(isFocused ? "cursor-text" : "cursor-pointer") + " duration-75 text-2xl w-2/3 h-14 rounded-l-xl px-6 outline-none placeholder-gray-400 bg-gray-700 focus:placeholder-opacity-50 focus:bg-gray-800"} />
